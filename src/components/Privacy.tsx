...
import { Zap, Shield, Lock, Eye, Server, ShieldCheck, Users } from 'lucide-react';
        ...
        <div className="max-w-4xl mx-auto space-y-16">
          ...
          <section className={cn(
            ...
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-2xl font-display font-black">Məxfilik Öhdəliyimiz</h2>
            </div>
            <p className={cn("text-lg font-medium leading-relaxed", isDark ? "text-neutral-300" : "text-neutral-600")}>
              Birstream olaraq şəxsi məlumatlarınızın məxfiliyi bizim prioritetimizdir. Bu siyasət, saytımızı istifadə edərkən topladığımız məlumatların növünü və onlardan necə istifadə etdiyimizi izah edir.
            </p>
          </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className={cn(
              ...
              <h3 className="text-xl font-display font-black">Toplanılan Məlumatlar</h3>
              <p className="text-sm text-neutral-500 font-medium leading-relaxed">
                Qeydiyyat zamanı təqdim olunan ad, e-poçt, ödəniş məlumatları və texniki giriş qeydləri (IP ünvanı, kukilər).
              </p>
            </div>
            ...
            <div className={cn(
              ...
              <h3 className="text-xl font-display font-black">Məlumatların İstifadəsi</h3>
              <p className="text-sm text-neutral-500 font-medium leading-relaxed">
                Xidmət keyfiyyətini artırmaq, ödəniş əməliyyatlarını həyata keçirmək və təhlükəsizliyi təmin etmək üçün istifadə olunur.
              </p>
            </div>
            ...
            <div className={cn(
              ...
              <h3 className="text-xl font-display font-black">Üçüncü Tərəflər</h3>
              <p className="text-sm text-neutral-500 font-medium leading-relaxed">
                Şəxsi məlumatlarınız qanunla tələb olunmadıqca və ya ödəniş keçidləri (payment gateways) kimi zəruri tərəfdaşlar istisna olmaqla, üçüncü tərəflərə satılmır və ya paylaşılmır.
              </p>
            </div>
            ...
            <div className={cn(
              ...
              <p className="text-sm text-neutral-500 font-medium leading-relaxed">
                Məlumatlarınızın qorunması üçün SSL şifrələmə və müasir kibertəhlükəsizlik protokollarından istifadə edilir.
              </p>
            </div>
          </div>
        </div>
