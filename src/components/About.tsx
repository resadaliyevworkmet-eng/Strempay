        ...
        <div className="max-w-4xl mx-auto space-y-20">
          ...
          <section className="text-center space-y-8">
            <motion.div
              ...
              className="space-y-4"
            >
              <h1 className="text-4xl md:text-7xl font-display font-black tracking-tight">Haqqımızda</h1>
              <p className={cn("text-lg sm:text-xl font-medium max-w-2xl mx-auto", isDark ? "text-neutral-400" : "text-neutral-500")}>
