  ...
  return (
    <div className={cn(
      ...
      <nav className={cn(
        ...
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            {!isLoaded ? (
              <div className="w-24 h-10 bg-neutral-200 dark:bg-neutral-800 animate-pulse rounded-xl" />
            ) : isSignedIn ? (
              <>
                <Link 
                ...
                <Link 
                  to="/dashboard"
                  className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-black hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-indigo-500/20"
                >
                  İdarəetmə paneli
                </Link>
              ...
              <>
                ...
                <SignUpButton mode="modal">
                  <button className="px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-black hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-indigo-500/20">
                    Qeydiyyat
                  </button>
                </SignUpButton>
              </>
      ...
      <section className="relative pt-48 pb-32 overflow-hidden text-center">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-6xl h-[600px] bg-indigo-600/10 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto px-6 relative z-10">
          <div className="space-y-10">
            <div className="space-y-6">
              ...
              >
                <span className="px-4 py-2 bg-indigo-500/10 text-indigo-500 rounded-full text-[10px] font-black uppercase tracking-[0.2em] border border-indigo-500/20">
              ...
              <motion.p 
                ...
                className={cn(
                  "text-xl font-medium max-w-2xl mx-auto leading-relaxed",
            ...
            >
              <div className="flex flex-col items-center gap-8">
                <div className="flex flex-wrap items-center justify-center gap-6">
                  {!isLoaded ? (
                    <div className="w-48 h-16 bg-neutral-200 dark:bg-neutral-800 animate-pulse rounded-[2rem]" />
                  ) : isSignedIn ? (
                    <Link 
                      to="/dashboard"
                      className="px-12 py-6 bg-indigo-600 text-white rounded-[2rem] font-black text-xl hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-indigo-500/40 flex items-center justify-center gap-3"
                    >
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                      <SignUpButton mode="modal">
                        <button className="w-full sm:w-auto px-12 py-6 bg-indigo-600 text-white rounded-[2rem] font-black text-xl hover:bg-indigo-700 transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-indigo-500/40 flex items-center justify-center gap-3 group">
                          İndi Başla
                      ...
                      <Link 
                        to="/donate/demo" 
                        className={cn(
                          "w-full sm:w-auto px-16 py-8 border-4 rounded-[2.5rem] font-black text-2xl transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-4 group relative overflow-hidden shadow-2xl",
                          isDark ? "border-indigo-500/50 text-indigo-400 hover:bg-indigo-500/10 shadow-indigo-500/10" : "border-indigo-200 text-indigo-600 hover:bg-indigo-50 shadow-indigo-200/20"
                        )}
                      >
                        <motion.div 
      ...
      <section className={cn(
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-20 space-y-4">
            ...
            <p className={cn("text-lg font-medium max-w-2xl mx-auto", isDark ? "text-neutral-400" : "text-neutral-500")}>
            ...
            {features.map((feature, i) => (
              <motion.div
                ...
                className={cn(
                  ...
                  isDark ? "bg-neutral-900/50 border-neutral-800/50 hover:border-indigo-500/50" : "bg-white border-neutral-100 hover:border-indigo-500/50 shadow-sm"
                )}
              >
                ...
                <p className={cn("text-sm leading-relaxed font-medium", isDark ? "text-neutral-400" : "text-neutral-500")}>
                  {feature.description}
                </p>
              </motion.div>
            ))}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
            <div className="space-y-10">
              <div className="space-y-4">
                <h2 className="text-4xl md:text-5xl font-display font-black tracking-tight">Yaradıcılar üçün <br /> <span className="text-indigo-600">Vədlərimiz</span></h2>
                <p className={cn("text-lg font-medium", isDark ? "text-neutral-400" : "text-neutral-500")}>
              ...
              <div className="space-y-6">
                ...
                <SignedIn>
                  <Link 
                    to="/dashboard"
                    className="inline-flex items-center gap-3 px-8 py-4 bg-indigo-600 text-white rounded-2xl font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20"
                  >
                    İdarəetmə panelinə Get
                    <ArrowRight size={20} />
                  </Link>
                ...
                <SignedOut>
                  <SignUpButton mode="modal">
                    <button className="inline-flex items-center gap-3 px-8 py-4 bg-indigo-600 text-white rounded-2xl font-black hover:bg-indigo-700 transition-all shadow-xl shadow-indigo-500/20">
                      Qeydiyyatdan Keç
                      <ArrowRight size={20} />
                    </button>
                  </SignUpButton>
            ...
            <div className="relative">
              <div className={cn(
                "p-10 rounded-[3rem] border shadow-2xl space-y-8 relative z-10",
                ...
                <div className="space-y-4">
                  {[
                    ...
                    <div key={i} className="flex items-center justify-between p-4 rounded-2xl bg-neutral-500/5 border border-neutral-500/10">
                      ...
                      <span className="font-black text-indigo-500">{user.amount}</span>
                    </div>
                  ))}
                </div>
              </div>
